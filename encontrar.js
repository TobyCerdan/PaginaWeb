...
function findTutors() {
    ...
    if (disponibles.length > 0) {
        var resultados = "Tutores Disponibles:<br>";
        disponibles.forEach(function(tutor) {
            resultados += tutor.nombre + " - Honorarios: $" + tutor.honorarios + "/hora<br>";
        });
        resultDiv.innerHTML = resultados;
    } else {
        resultDiv.innerHTML = "No hay tutores disponibles para el día y hora seleccionados.";
    }
}
